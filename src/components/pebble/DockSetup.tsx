    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto w-full max-w-xl px-4 pt-6 pb-10 sm:px-6 lg:pt-10">
        <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3">
          <button type="button" onClick={goBack} className="press hover:bg-accent -ml-2 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full" aria-label="Back">
